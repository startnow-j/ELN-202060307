...
> **文档版本**: v2.4
> **最后更新**: 2025-03-05
> **适用版本**: v3.0 → v3.1 → v3.2 → v3.3 → v3.3.5
...
| v3.3 | 2025-03-28 | 超级管理员、暂存实验、权限增强、导航优化 | 🔄 开发中 |
...
| **审计日志** | 操作记录 | v3.0 |
| **界面导航** | 全局导航改进（子页面可直接切换模块） | v3.3 |
| **评分系统** | 新评分标准（100分制，附件增量分，标签加分） | v3.3 |
| **AI提取** | PDF解析修复，支持多附件选择提取 | v3.3 |
| **AI提取** | 支持.doc格式文件解析（使用antiword） | v3.3 (2025-03-02) |
| **评分系统** | 修复评分满分问题，修复保存后评分变化 | v3.3 (2025-03-02) |
| **评分系统** | 附件评分优化：基础15分+每个5分 | v3.3 (2025-03-02) |
| **项目管理** | 项目主负责人字段（手写填入） | v3.3.1 (2025-03-02) |
| **项目管理** | 全局视角切换（管理员查看所有项目） | v3.3.1 (2025-03-02) |
| **项目管理** | 视角简化（普通视角/全局视角） | v3.3.1 (2025-03-02) |
| **项目管理** | 成员数计算优化（memberCount字段） | v3.3.1 (2025-03-02) |
...
| **审核历史** | 简化重构：卡片化设计、时间箭头指示 | v3.3.7 (2025-03-07) |
| **审核历史** | 移除冗余信息（IP、电子签名等） | v3.3.7 (2025-03-07) |
| **审核历史** | 显示目标审核人（提交给/转交给） | v3.3.7 (2025-03-07) |
| **解锁功能** | 解锁申请处理Tab | v3.3.7 (2025-03-07) |
| **解锁功能** | 批准/拒绝解锁并记录到审核历史 | v3.3.7 (2025-03-07) |
| **锁定状态** | 显示锁定时间和附件数 | v3.3.7 (2025-03-07) |
...
| 日期 | 版本 | 更新内容 |
|------|------|----------|
| 2025-03-07 | v2.6 | v3.3.7 审核历史重构与解锁功能完善：简化展示、卡片化设计、解锁申请处理Tab |
| 2025-03-05 | v2.5 | v3.3.6 全局视角功能文档完善：删除过时文档、完善模块文档 |
| 2025-03-05 | v2.4 | v3.3.5 视角切换功能修复：统一API参数、独立数据获取、修复双重请求问题 |
| 2025-03-02 | v2.3 | 新增项目管理模块优化记录（主负责人、全局视角、成员数优化） |
| 2025-03-02 | v2.2 | 修复AI提取.doc文件支持，修复评分系统问题 |
| 2025-03-28 | v2.1 | 导航功能优化：子页面可直接切换模块，无需退出 |
