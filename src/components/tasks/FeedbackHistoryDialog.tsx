...
import { History, Loader2, User, CheckCircle, RefreshCw } from 'lucide-react'
                ...
                >
                  ...
                  {feedback.attachments && feedback.attachments.length > 0 && (
                    <div className="mt-3 pl-10">
                      <p className="text-xs text-muted-foreground mb-1">批注附件：{feedback.attachments.map(att => att.name).join('、')}</p>
                    </div>
                  )}
                </div>
              ))}
