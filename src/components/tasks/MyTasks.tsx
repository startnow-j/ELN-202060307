...
export function MyTasks({ onViewExperiment, onEditExperiment }: MyTasksProps) {
  ...
  // React Query hooks
  const { data: experiments = [], isLoading: experimentsLoading, refetch: refetchExperiments } = useExperiments({ viewMode })
  const { data: projects = [], isLoading: projectsLoading } = useProjects({ viewMode })
  const { data: unlockRequests = [], isLoading: unlockRequestsLoading, refetch: refetchUnlockRequests } = useUnlockRequests()
    ...
    <div className="space-y-6 p-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="unlock-requests">
          <UnlockRequestList
            requests={unlockRequests as UnlockRequestItem[]}
            isLoading={unlockRequestsLoading}
      ...
      <ProcessUnlockDialog
        ...
        onSuccess={refetchUnlockRequests}
      />
